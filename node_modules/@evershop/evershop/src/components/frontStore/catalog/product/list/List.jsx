...
export default function ProductList({ products = [], countPerRow = 4 }) { // Default to 4 per row
  console.log('Product List Data:', products); // Log the products array
  ...
  const getClassName = (count) => {
    switch (count) {
      ...
      case 5:
        return 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-6';
      case 3:
      default:
        return 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6';
    }
  };

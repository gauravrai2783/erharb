...
export default function Logo({
  themeConfig: {
    logo: { src, alt = 'RugHarbor', width = '128px', height = '128px' }
  }
}) {
    ...
    <div className="logo">
      ...
      {!src && (
          <a href="/" className="logo-icon">
            ...
            {/*  viewBox="0 0 128 146"*/}
            {/*  fill="none"*/}
            {/*  xmlns="http://51.20.144.189/images/rugharbor__1_-removebg-preview.png"*/}
            {/*>*/}
            <img
                // style={defaultStyle}
                alt="Luxurious Carpets and Rugs"
                src="rugharbor-logo.ico"
